...
export default function BioModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center px-4 py-8" style={{ background: 'rgba(10,5,2,0.65)' }}>
      <div
        ref={cardRef}
        className="queue-scroll w-full max-w-md max-h-[85vh] overflow-y-auto rounded-3xl backdrop-blur-2xl border shadow-2xl fade-in-up"
      ...
      >
        ...
        <div className="px-6 pb-6 -mt-6 relative">
          ...
          <Section title="An Accidental Singer">
            ...
            style before finding a voice entirely his own. Singing was always what he actually wanted to do — acting
            was closer to an obligation, one his family and the industry kept pulling him back into. S. D. Burman
            heard him singing informally and signed him for playback work; years later, S. D.'s son R. D. Burman
            built some of the era's biggest hits specifically around his voice.
          </Section>
          ...
          <Section title="The Voice That Did Everything">
            ...
            ballads, chaotic comic numbers, and yodel-laced disco-pop without ever sounding like he was performing a
            different person each time. He's widely credited with bringing yodeling into Hindi film music — nobody
            else was doing it quite like him. He holds the record for the most Filmfare Awards for Best Male
            Playback Singer: eight.
          </Section>

          <Section title="More Than a Voice">
            He also acted, composed, wrote, produced, and directed — a rare multi-hyphenate career, almost all of it
            self-taught. His comic film roles, chaotic and physical and often half-improvised, remain some of Hindi
            cinema's most fondly remembered performances.
          </Section>
